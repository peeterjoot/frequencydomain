...
Additionally, the electric and magnetic fields are perpendicular
...
With \( I \BH = (1/\eta) \kcap \BE \), the electric field can be expressed in terms of the magnetic field by left multiplication with \( \eta \kcap \), giving
...
The conventional cross product relationship is easily recovered from this

\begin{dmath}\label{eqn:frequencydomain:320}
= \eta I \kcap \wedge \BH
= \eta I^2 \kcap \cross \BH
= \eta \BH \cross \kcap.
\end{dmath}

It is also possible to solve for the direction of the propagation by right multiplying \( \kcap \Ecap = I \Hcap \) with \( \Ecap \) giving
...
This can be written in the conventional cross product form if desired

\begin{dmath}\label{eqn:frequencydomain:360}
\kcap
= I \Hcap \Ecap
= I (\Hcap \wedge \Ecap)
= I^2 (\Hcap \cross \Ecap)
...
Observe that the \R{3} pseudoscalar can be written as \( I = \kcap \Ecap \Hcap \), reflecting the fact that \( \kcap, \Ecap, \Hcap \) form a right handed triple.
